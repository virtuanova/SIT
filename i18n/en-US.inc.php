...
$strContactRecordExists = 'A contact record already exists with that Last Name and Email address';
$strContactResetPassword = 'Contact Reset Password';
$strContactNotes = 'Contact Notes:';
$strContacts = 'Contacts';
$strContactsForename = 'Contact\'s first name';
...
$strEmailHolidaysRequestedDesc = 'Notifies a user that they need to approve vacations';
...
$strIncidentResolved = 'The incident has been resolved or reprioritized.nThe issue should now be brought to a close or a new problem definition created within the service level';
...
$strUsersHolidays = '%s\'s Vacations';
